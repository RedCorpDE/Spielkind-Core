...
// Window: event starts in exactly 7 days, +/- 30 minutes
const DAYS = 7;
const WINDOW_HALF_MS = 30 * 60 * 1000;

export const clientMessage7dJob = createJob({
  triggerType: 'client_message_7d',
  ...
  buildPayload: (row) => buildClientMessagePayload(row, 'client_message_7d'),
