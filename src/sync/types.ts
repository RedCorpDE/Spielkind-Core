...
const regiondoBuyerFieldSchema = z
  .object({
...
export const regiondoPurchaseDataSchema = z
  .object({
    ...
    buyer_data: z.array(regiondoBuyerFieldSchema).optional(),
...
export const regiondoPurchaseUpdateDetailsSchema = z
  .object({
...
export const regiondoPurchaseDataPushSchema = z
  .object({
    ...
    updated_items_details: regiondoPurchaseUpdateDetailsSchema.optional(),
